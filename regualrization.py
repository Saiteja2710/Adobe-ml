...
# Example usage
csv_path = "input.csv"  # Path to your CSV file
output_image_path = "plotted_image.png"
output_smoothed_image_path = "smoothed_image.jpg"
output_smoothed_csv_path = "smoothed_contours.csv"

# Step 1: Plot CSV
paths = read_csv(csv_path)
plot(paths, output_image_path)

# Step 2: Process Image
process_image(output_image_path, output_smoothed_image_path, output_smoothed_csv_path)
